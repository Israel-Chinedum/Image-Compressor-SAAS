  ...
  return (
    <div className="relative w-full">
      <div className="mx-auto flex max-w-6xl flex-col gap-12 px-6 py-12">
        <AdSlot
          placement="sidebar"
          className={`absolute top-10 left-10 hidden xl:flex`}
        />
        <section className="flex flex-col items-center gap-4 text-center">
          ...
          <AdSlot placement="sidebar" className={`top-10 left-10 xl:hidden`} />
          ...
          {count > 0 && (
            <div className="mt-2 flex items-center gap-6 rounded-2xl border border-(--border-color) bg-[var(--bg-raised) px-6 py-4">
              ...
              <div className="text-left">
                ...
                <p className="text-xs text-(--fg-muted)">smaller on average</p>
              </div>
            </div>
          )}
        </section>
